    ...
    Command::new(clap::crate_name!())
        ...
        .arg( // CSV detail output file name
            Arg::new("csv-file")
                ...
                .long_help("The name of the CSV into which the detailed information for each file is to be written. Default is 'details.csv' if not specified.")
                .num_args(0..)
        ...
        .arg( // CSV summary output file name
            Arg::new("summary-file")
                ...
                .long_help("The name of the CSV into which summary information is to be written. Default is 'summary.csv' if not specified.")
                .num_args(0..)
