    ...
    Command::new("id3tag")
        ...
        .arg( // Front cover picture candidate
            Arg::new("picture-front-candidate")
                ...
                .long_help("The front cover picture candidate file name. Example: 'front.jpg' or 'folder.jpg'. Looks for the cover picture alongside the music first, then in any directories supplied using the `--picture-search-folder` argument.")
                .takes_value(true)
                .multiple_occurrences(true)
                .require_equals(false).help_heading(tags_name)
        )
        ...
        .arg( // Front cover picture candidate
            Arg::new("picture-back-candidate")
                ...
                .long_help("The back cover picture candidate file name. Example: 'back.jpg' or 'back-cover.jpg'. Looks for the cover picture alongside the music first, then in any directories supplied using the `--picture-search-folder` argument.")
                .takes_value(true)
                .multiple_occurrences(true)
                .require_equals(false).help_heading(tags_name)
        )
